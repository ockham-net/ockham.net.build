Import-Module (Join-Path $PSScriptRoot (Join-Path modules common-utils.psm1))
Import-Module (Join-Path $PSScriptRoot (Join-Path modules fs-utils.psm1))
...
. (Join-Path $PSScriptRoot (Join-Path modules project-types.ps1)) | Out-Null
